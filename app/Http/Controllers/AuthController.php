...
class AuthController extends Controller
{
    public function login(Request $request) {
        ...
        if ($user === null) {
            return response()->json(['status' => 'error', 'message' => 'No user exists with this email']);
        }
    ...
    public function register(Request $request) {
        ...
        if (strlen($password) < 6) {
            return response()->json(['status' => 'error', 'message' => 'Password should be minimum of 6 characters']);
        }
